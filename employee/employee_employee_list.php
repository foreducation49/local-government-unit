            ...
            <div class="row">
                <div class="col-md-12">
                    <div id="displayDataTable">
                        <!-- employee_employee_list_displaydata.php -->
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function displayData()
    {
        ...
        $.ajax
        ({
            url:"employee_employee_list_displaydata.php",
            type:'post',
            data:{
    ...
    function adduser()
    {
        ...
        $.ajax
        ({
            url:"employee_employee_list_insert.php",
            type:'post',
            data:
            {
                fnameSend:fnameAdd,
    ...
    {
        $.ajax({
            url:"employee_employee_list_delete.php",
            type:'post',
            data:{
                deletesend:deleteid
            },
    ...
    function getdetails(updateid)
    {
        ...
        $.post("employee_employee_list_update.php", {updateid:updateid}, function(data,status)
        {
    ...
    function updatedetails()
    {
        ...
        $.post("employee_employee_list_update.php",
        {
