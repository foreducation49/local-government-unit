                        ...
                        <div class="row">
                            <div class="col-lg-4 col-xl-4">
                                <div class="card-box text-center">
                                    ...
                                    <h4 class="mb-0">System Employeer</h4>
                                    <p class="text-muted">@System_Employee</p>
                                    <div class="text-left mt-3">
                                        <p class="text-muted mb-2"><strong>Full Name :</strong> <span class="ml-2">System employee</span></p>
                                        <p class="text-muted mb-2"><strong>Email :</strong> <span class="ml-2 ">edgeniel@mail.com</span></p>
                                    </div>
                                </div> <!-- end card-box -->
                            </div> <!-- end col-->
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" required="required" value="Edgeniel" name="fname" class="form-control" id="inputFirstname">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input required="required" type="text" value="Buhian" name="lname" class="form-control"  id="inputPassword">
                                                        </div>
                                                    </div> <!-- end col -->
                                                </div> <!-- end row -->
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input required="required" type="email" value="edgeniel@mail.com" class="form-control" name="email" id="inputEmail">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
