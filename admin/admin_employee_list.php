    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="adduserModalLabel">Add Employee</h1>
        ...
        <div class="card-header">
            <h4>Employee List
                ...
                <button type="button" class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#adduserModal">
                    <i class='bx bx-plus-medical' ></i> Add Employee
                </button>
...
<script>
    ...
    function displayData()
    {
        ...
        $.ajax
        ({
            url:"admin_employee_list_displaydata.php",
            type:'post',
            data:{
    ...
    var passwordAdd = $('#inputPassword').val();
    var roleAdd = $('#inputRole').val(); // Get the selected role

    $.ajax({
        url: "admin_employee_list_insert.php",
        type: 'post',
        data: {
            fnameSend: fnameAdd,
            lnameSend: lnameAdd,
            ...
            roleSend: roleAdd // Include role in the data sent
        },
    ...
    {
        $.ajax({
            url:"admin_employee_list_delete.php",
            type:'post',
            data:{
                deletesend:deleteid
            },
    ...
    function getdetails(updateid)
    {
        ...
        $.post("admin_employee_list_update.php", {updateid:updateid}, function(data,status)
        {
    ...
    function updatedetails()
    {
        ...
        $.post("admin_employee_list_update.php",
        {
